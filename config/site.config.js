...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'flynn@flynnoct.onmicrosoft.com',
  ...
  email: 'mailto:contact@flynmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/flynnoct',
    },
  ],
